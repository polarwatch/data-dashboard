---
title: "CoastWatch-PolarWatch (Under Development)"
format: 
  dashboard:
...
fig = px.bar(top10_ice_years, x='dataset_title', y='all_requests', 
              color='year', labels={"dataset_title": "Dataset Name", "all_requests": "Requests"}, 
              color_discrete_sequence=colors[::-1],barmode='group', width=None)
